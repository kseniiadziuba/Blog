    ...
    public class BlogDbInitializer : DropCreateDatabaseIfModelChanges<BlogDbContext>
    {
        ...
        protected override void Seed(BlogDbContext db)
        {
            ...
            db.Articles.Add(new Article("Смерть Ахиллеса", "25/04/09",
                ...
                "смерть Соболева для его ближайших соратников должна была оказаться позорной," + "недостойной," + "чтобы его имя не могло быть использовано в качестве символа возможными продолжателями его дела.Ахимас нашёл решение этой непростой задачи: он нанял известную кокотку Ванду Толле," +
